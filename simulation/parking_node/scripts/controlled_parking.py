        ...
        while not rospy.is_shutdown():
          ...
          if len(pos) > 1:
              ...
              if gap < 1.05:
                  ...
                  #c.moveForTime(speed, 0, time)
                  if speed_begin_start > speed_begin_end:
                    speed_begin_start = speed_begin_end
                  else:
                    speed_begin_start = speed_begin_start + 0.005
                  c.moveOnce(speed_begin_start, 0)
              ...
              print 'error no parking slot detected'
        ...
        while not rospy.is_shutdown():
		        ...
		        if len(pos) > 1:
			        ...
			        if goalDistanceDeviation > 0.05:
			          ...
			          modifiedAngle =  -0.06
			        #c.moveForTime(speed, modifiedAngle, time)
